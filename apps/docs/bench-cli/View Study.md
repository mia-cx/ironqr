...
## Files
- latest report output: `tools/bench/reports/study-view-proposals.json`
- timestamped report snapshots: `tools/bench/reports/runs/<timestamp>-<short-sha>/study-view-proposals.json`
